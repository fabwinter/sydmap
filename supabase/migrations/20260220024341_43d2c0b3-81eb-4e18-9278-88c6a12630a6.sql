...
-- Drop both overloads and recreate a single one with jsonb
DROP FUNCTION IF EXISTS public.admin_update_activity(uuid, json);
DROP FUNCTION IF EXISTS public.admin_update_activity(uuid, jsonb);
